...
two windows stood up as bars, with what is left of each under them, and again
for the charge, the network, the address and the commit it is running. Rightward
comes back.
