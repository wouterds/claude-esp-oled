...
// One report. `along` is how far down the glass the finger is, in the same
// direction and the same units the scene is drawn in, so that a finger moving
// towards the bottom of the picture always makes it larger.
//
