...
void loop() {
  ...
  if (buttonPressed()) {
    // A pair asks for the death, on top of whatever the press itself meant.
    // Nothing raises that one on its own yet, and a sound nobody can hear is a
    // sound nobody can tell is wrong.
