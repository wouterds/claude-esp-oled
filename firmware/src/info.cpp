...
constexpr int16_t PERCENT_TOP = 206;
constexpr int16_t PERCENT_SCALE = 4;
constexpr int16_t NETWORK_TOP = 252;
constexpr int16_t ADDRESS_TOP = 274;
constexpr int16_t COMMIT_TOP = 302;
